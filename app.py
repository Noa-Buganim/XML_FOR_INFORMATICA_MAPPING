...
def main():
    ...
    :root {
        ...
        --muted: #667085;
        --primary: #3f6c8e;
        --primary-hover: #355c79;
        --border: rgba(63, 108, 142, 0.16);
    ...
    .stTextArea textarea:focus {
        ...
        box-shadow: 0 0 0 3px rgba(63, 108, 142, 0.12) !important;
    }

    [data-testid="stButton"] button {
        background: linear-gradient(180deg, #5e88a6 0%, #3f6c8e 100%) !important;
        color: white !important;
        border: 0 !important;
        border-radius: 16px !important;
        box-shadow: 0 10px 24px rgba(63, 108, 142, 0.18);
        font-weight: 700;
        padding: 0.8rem 1.1rem;
    }

    [data-testid="stButton"] button:hover {
        background: linear-gradient(180deg, #6a96b2 0%, #355c79 100%) !important;
    }

    .stDownloadButton button {
        background: #e9f0f5 !important;
        color: #1f3347 !important;
        border: 1px solid rgba(63, 108, 142, 0.18) !important;
        border-radius: 16px !important;
    }
    ...
    if st.button(btn_label, use_container_width=True, type="primary"):
        if "WF PARAMETERS" in delta_stage:
            ...
            not ddl_master_input or not ddl_detail_input or not ddl_master_input.strip() or not ddl_detail_input.strip()
        ):
